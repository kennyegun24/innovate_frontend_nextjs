...
export const posts = [
  ...
  },
  {
    ...
    isLiked: false,
    id: 2,
    text: "the entire opinion pour aside from pour aside from the entire opinion on top of that whoever pour po",
    author_id: 3,
  ...
  },
  {
    ...
    isLiked: false,
    id: 4,
    text: "the previous unit jump with respect to jump with respect to the previous unit \nundeniably it jump jum",
    author_id: 5,
